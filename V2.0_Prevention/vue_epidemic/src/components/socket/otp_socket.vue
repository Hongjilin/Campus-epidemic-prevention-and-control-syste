            ...
            <el-col :span="24" style="">
                <el-card class="group">
                    <div class="group_head">
                        <el-page-header  class="title" @back="goBack" content="魏工养老培训班">
                        ...
                        <ul>
                            <li v-for='item in commlist' style=" list-style-type:none;">
                                <div class="msgOther" v-if="!item.if">
                                    <div class="head_img"><img :src="imgpath+item.msgData.img" alt=""></div>
                                    <div class="msg">
                                        <div class="msg_title"><span v-text="item.msgData.name"></span> <i
                                                v-text="timeDetia(item.date)">2020-8-28</i>
                                        </div>
                                        <div>
                                ...
                                <div class="msgMy" v-if="item.if">
                                    <div class="msg">
                                        <div class="msg_title"><i v-text="timeDetia(item.date)">2020-8-28</i><span
...
<script>
    export default {
        ...
        sockets: {
            ...
            //获取聊天数据
            getmsg(data) {
                if (data.msgData.uid == window.localStorage.getItem("id"))
                    data.if = true
                else data.if = false
